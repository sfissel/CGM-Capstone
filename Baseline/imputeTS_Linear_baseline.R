...
test_set <- read.csv('./Documents/UVA_MSDS/Capstones/Glucose/CGM_data/Glucose_Baseline_Set.csv')
test_complete <- read.csv('./Documents/UVA_MSDS/Capstones/Glucose/CGM_data/Glucose_Baseline_Set_Complete.csv')
...
linear_data <- inner_join(test_joined,linear_data, by=c('SID','Day','DailyTI_Index'))



#change
write_csv(linear_data, './Documents/UVA_MSDS/Capstones/Glucose/CGM_data/Linear_Baseline_Prediction.csv')
